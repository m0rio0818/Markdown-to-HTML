    ...
    <div class="flex h-screen flex-col bg-sky-500 lg:flex-row px-5 lg:px-5 py-5 lg:py-2">
        ...
        <div class="w-full lg:w-1/2 h-1/2 md:h-3/4 lg:h-full overflow-scroll" style="border:1px solid grey">
            <div class="pt-3 flex justify-center">
                ...
                <button id="highlight" value="on" class="bg-transparent mx-1 hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-1 px-2 border border-blue-500 hover:border-transparent rounded">
                    Highlight : ON
                </button>
